...
//		List<ConservatorRole> list = new ArrayList<>();
//		ConservatorRoleDao.deleteConservatorRolesByUids(uids);
//		for(String uid:uids.split(",")) {
//			for(String rid:rids.split(",")) {
//				ConservatorRole ConservatorRole = new ConservatorRole();
//				ConservatorRole.setUid(Integer.parseInt(uid));
//				ConservatorRole.setRid(Integer.parseInt(rid));
//				list.add(ConservatorRole);
//			}
//		}JSONObject jo = new JSONObject();
//		PrintWriter out = null;
//		try {
...
//	}
	...
	public void queryAll() {
		List<Conservator>list=ConservatorService.queryAll(Conservator.class);
		try {
			PrintWriter out = response.getWriter();
